...
DriversResponse driversResponseFromJson(String str) =>
    DriversResponse.fromJson(json.decode(str));

String driversResponseToJson(DriversResponse data) =>
...
class DriversResponse {
  ...
  factory DriversResponse.fromJson(Map<String, dynamic> json) =>
      DriversResponse(
        ...
        apiMapping: List<ApiMapping>.from(
            json["apiMapping"].map((x) => ApiMapping.fromJson(x))),
      );
...
class Content {
  ...
  final Manufacturer team;
  final Chapionship chapionship;
  final Chapionship championship;
  ...
  factory Content.fromJson(Map<String, dynamic> json) => Content(
        ...
        name: json["name"],
        key: json["key"],
        car: carValues.map[json["car"]]!,
        country: Country.fromJson(json["country"]),
        type: contentTypeValues.map[json["type"]]!,
        team: manufacturerValues.map[json["team"]]!,
        chapionship: chapionshipValues.map[json["chapionship"]]!,
        championship: chapionshipValues.map[json["championship"]]!,
        contentClass: classValues.map[json["class"]]!,
...
enum Chapionship { WRC }

final chapionshipValues = EnumValues({"WRC": Chapionship.WRC});

enum Class { WRC }

final classValues = EnumValues({"wrc": Class.WRC});
...
enum ImageType { LANDSCAPE }

final imageTypeValues = EnumValues({"landscape": ImageType.LANDSCAPE});
...
final manufacturerValues = EnumValues({
  "HYUNDAI SHELL MOBIS WORLD RALLY TEAM":
      Manufacturer.HYUNDAI_SHELL_MOBIS_WORLD_RALLY_TEAM,
  "M-SPORT FORD WORLD RALLY TEAM": Manufacturer.M_SPORT_FORD_WORLD_RALLY_TEAM,
  "TOYOTA GAZOO RACING WORLD RALLY TEAM":
      Manufacturer.TOYOTA_GAZOO_RACING_WORLD_RALLY_TEAM
});

enum ContentType { CO_DRIVER, DRIVER }

final contentTypeValues = EnumValues(
    {"CO-DRIVER": ContentType.CO_DRIVER, "DRIVER": ContentType.DRIVER});
